...
function Header() {
  ...
  return (
    <div className="shadow flex px-2 py-5 justify-between">
      <img
        onClick={""}
        className="w-9 ml-3"
      ...
      <div>
        <input
          className="w-[550px] px-5 py-2 rounded-l-full bg-gray-100"
          type="text"
          name=""
          id=""
          placeholder="Search..."
        />
        <button className="w-[50px] bg-slate-100 rounded-r-full h-9 border-red-50">
          🔍
        </button>
      </div>
      <img
