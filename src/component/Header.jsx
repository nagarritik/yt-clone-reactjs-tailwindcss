...
import { flagMenu } from "../slice/appConfigSlice";

function Header() {
  const dispatch = useDispatch()
  return (
    <div className="flex h-[60px] justify-between items-center shadow">
      <div className="flex gap-5 pl-5">
        <RxHamburgerMenu size={25} color="gray" onClick={()=>{
          dispatch(flagMenu())
        }}/>
        <img
      ...
      <div className="flex gap-5 items-center">
        <div className="flex">
          <input type="text" name="serach" id="search" placeholder="Search" className="w-[550px] rounded-l-full px-5 py-2 border border-gray-500"/>
          <div className="bg-gray-200 w-[60px] flex justify-center items-center rounded-r-full border border-gray-500">
            <AiOutlineSearch size={25} />
          </div>
        </div>
        <div className="bg-gray-200 rounded-full p-2">
          <BsFillMicFill size={20} color="gray"/>
        </div>
      </div>
